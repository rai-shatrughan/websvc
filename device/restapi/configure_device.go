...
//go:generate swagger generate server --target ../../device --name Device --spec ../../swaggers/device.yaml --principal models.Principal

func configureFlags(api *operations.DeviceAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.DeviceAPI) http.Handler {
	...
	if api.GetDeviceDeviceIDHandler == nil {
		api.GetDeviceDeviceIDHandler = operations.GetDeviceDeviceIDHandlerFunc(func(params operations.GetDeviceDeviceIDParams, principal *models.Principal) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetDeviceDeviceID has not yet been implemented")
		})
	}
	if api.GetDeviceVersionHandler == nil {
		api.GetDeviceVersionHandler = operations.GetDeviceVersionHandlerFunc(func(params operations.GetDeviceVersionParams, principal *models.Principal) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetDeviceVersion has not yet been implemented")
		})
	}
