...
func NewAuthAPI(spec *loads.Document) *AuthAPI {
	return &AuthAPI{
		...
		PostLoginHandler: PostLoginHandlerFunc(func(params PostLoginParams, principal *models.Principal) middleware.Responder {
...
func (o *AuthAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *AuthAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}
...
func (o *AuthAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
